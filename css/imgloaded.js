...
(function() {
    ...
    const ldconfig = {
      light: {
        smallSrc: 'https://img.picgo.net/2025/04/10/12882bbd6bcc960c5.png', //浅色模式 小图链接 尽可能配置小于100k的图片 
        largeSrc: 'https://img.picgo.net/2025/04/10/1c9c08baf98ca75cb.png', //浅色模式 大图链接 最终显示的图片
      ...
      dark: {
        ...
        largeSrc: 'https://s21.ax1x.com/2025/04/10/pEgxyX4.png', //深色模式 大图链接 最终显示的图片
